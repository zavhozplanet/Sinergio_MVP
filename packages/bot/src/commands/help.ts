...
🏪 <b>Маркетплейс</b> — Індивідуальні та групові оферти від учасників
...
🤝 <b>Підписки</b> — Слідкуйте за улюбленими продюсерами

<b>S-Index</b> нараховується автоматично:
• +10 — за виконане замовлення (продюсер)
• +5 — за оплачене замовлення (покупець)
